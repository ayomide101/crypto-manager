        ...
        twitterFeed: function(){
            ...
            if( $twitterFeedEl.length > 0 ){
                $twitterFeedEl.each(function() {
                    ...
                    var loaderLocation = window.location.protocol+'//'+window.location.hostname+port+'/api/social/twitter/tweets';
                    if( !twitterFeedLoader ) {
                    	// twitterFeedLoader = 'api/social/twitter/tweets';
                        twitterFeedLoader = loaderLocation;
                    }
